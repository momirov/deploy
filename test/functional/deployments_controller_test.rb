...
class DeploymentsControllerTest < ActionController::TestCase
  ...
  test "should create deployment" do
    assert_difference('Deployment.count') do
      post :create, deployment: { log: @deployment.log, run_time: @deployment.run_time, success: @deployment.success, user: @deployment.user }
    end
  ...
  test "should update deployment" do
    put :update, id: @deployment, deployment: { log: @deployment.log, run_time: @deployment.run_time, success: @deployment.success, user: @deployment.user }
    assert_redirected_to deployment_path(assigns(:deployment))
  end
